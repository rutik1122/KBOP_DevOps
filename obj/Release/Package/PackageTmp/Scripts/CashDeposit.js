try {
    ...
    function closeDialog_New(i) {
        ...
        $.ajax({
            ...
            //data: { pType: ProcessType, INtellerid: gusername, response: response, transtype: transtype, transRefNo: RegNo, BranchSolID: BrCode, CreditAccountNo: acc, PayeeName: PName, SlipAmount: amt1, ChqAmount: amt1, recipt: PrintCall, Denoms: dArray_Print1, DenomCount: dCount_Print1, imageUrl: ImageUrl },
