...
function itemReasonPopUp(printer) {

    debugger;

    popup_bar2.addEventListener('mousedown', mouseDown, false);

    popup2.style.top = "20px";
    popup2.style.left = "200px";
    var SCROLL_WIDTH = 24;

    popup2.style.width = "350px";

    popup2.style.display = "block";

    var tableSignData = document.getElementById('itemReasonTable');

    debugger;


    $("#itemReasonTable").find("tr:gt(0)").remove();
...
function AddRecordRow(print) {
    ...
    if ($("#itemReasonTable tbody").length == 0) {
        $("#itemReasonTable").append("<tbody></tbody>");
    }
    // Append row to <table>
    $("#itemReasonTable tbody").append(
...
function RecordTableRow(print) {
    ...
    var Ret_Row =
        ...
        '<td style="text-align: center; font-size:15px;" onclick="submitReason(\'' + print.Code + '\',\'' + print.Description + '\')" >' + print.Code + '</td>' +
        '<td style="text-align: center; font-size:15px;" onclick="submitReason(\'' + print.Code + '\',\'' + print.Description + '\')" >' + print.Description + '</td>' +
        '</tr>';
...
function ChqSlipPopUp(imgtype) {
    ...
    if (imgtype == null) {
        ...
        document.getElementById('id_title').innerHTML = 'Instrument Image';
    }
        ...
        if (imgtype == "FG")
            ...
            document.getElementById('id_title').innerHTML = 'Signature';
    }
