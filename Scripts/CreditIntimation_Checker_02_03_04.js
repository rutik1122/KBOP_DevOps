try {
    ...
    function RecordTableRow(print) {
        ...
        if (Scanning_Type == "2" || Scanning_Type == "3" || Scanning_Type == "4") {
    ...
    function setTableData() {
       ...
       // var VerfSign = document.getElementById("tblChequeData").getElementsByTagName('tr')[GlobalRowNo].cells[29].innerHTML;
        //var VerfSign = "";
        //var tblChequeData = document.getElementById("tblChequeData");

        //if (tblChequeData) {
        //    var rows = tblChequeData.getElementsByTagName('tr');
        //    if (GlobalRowNo < rows.length) {
        //        var cells = rows[GlobalRowNo].cells;
        //        if (cells.length > 33) {  // Check if there are enough cells
        //            VerfSign = cells[33].innerHTML;
        //        }
        //    }
        //}
            ...
            if (verifyDone == false) {
                ...
                if (penSlip > 0)
                    ...
                    if (objCells[9].innerHTML == "C")
                        ...
                        msg = msg + penChq + " Withdrawal Slip";
    ...
    function DataPush(descision) {
        ...
        if (descision == "R") {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    RejectCode: code, RejectDesc: desc, pType: 'CI', decision: 'R', VerificationLevel: verfLevel, transRefNo: RefNo, cid: count_id
                },
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    pType: 'CI', decision: 'B', VerificationLevel: verfLevel, transRefNo: RefNo, cid: count_id
                },
                success: CheckerList
                //success: window.open(rooturl + "Checker/Index", "_self")
            });
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    pType: 'CI', decision: 'A', VerificationLevel: verfLevel, transRefNo: RefNo, L3VerfyReq: verf_l3_req, BankCode: BankCode
                },
                success: AcceptSuccess
            });
            ...
            if (desc.trim() != "" && desc.trim() != null) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        RejectDesc: desc, pType: 'CI', decision: 'ROLLBACK', VerificationLevel: verfLevel, transRefNo: RefNo, cid: count_id
                    },
