try {
    ...
    function RecordTableRow(print) {
        ...
        if (Scanning_Type == "3" || Scanning_Type == "4" || Scanning_Type == "5" || Trans_type == "TRF06"
            || Trans_type == "TRF07" || Trans_type == "TRF08") {
    ...
    function VerifyData() {
        ...
        if (verifyDone == true /*&& scanCount == true && amtValid == true && accvalid == true && otherVerf == true && UV_Flag == true*/) {
            ...
            document.getElementById("successMsg").innerHTML = "All Record Verification Completed!";
        }
        else {
            $("#tbl_verf_fail").show();
            var msg = document.getElementById("errorMsg").innerHTML;
    ...
    function AcceptSuccess(result) {
        ...
        if (BankCode == "240") {
            document.getElementById("successMsg_accept").innerHTML = outData[0];
        }
        else if (BankCode == "059") {
            if (outData[1] != null && outData[1] != "") {
                if (outData[1] == "YES")
                    document.getElementById("successMsg_accept").innerHTML = outData[0] + "; CBS Ref: " + outData[2];
                else
                    document.getElementById("successMsg_accept").innerHTML = outData[0];
            }
        }
    ...
    function FailedResponse(result) {
        ...
        var outData = result.responseJSON.Message.split("|");
        if (BankCode == "240") {
            document.getElementById("successMsg_accept").innerHTML = outData[0];
        }
        else if (BankCode == "059") {
            if (outData[1] != null && outData[1] != "") {
                if (outData[1] == "YES")
                    document.getElementById("successMsg_accept").innerHTML = outData[0] + "; Desc: " + outData[2];
                else
                    document.getElementById("successMsg_accept").innerHTML = outData[0];
            }
        }
