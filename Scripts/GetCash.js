try {
    ...
    function CashInput(denom) {
        ...
        debugger;
        // 50 - Paise
        var in_50p = parseFloat(document.getElementById("lbl_50p_in").innerHTML);
        var out_50p = parseFloat(document.getElementById("lbl_50p_out").innerHTML);
        var DVal_50p = parseFloat(document.getElementById("lbl_50p_DValue").innerHTML);
        var AVal_50p = parseFloat(document.getElementById("lbl_50p_AValue").innerHTML);
        var input_50p = 0;
        if (document.getElementById("input_50p").value == null || document.getElementById("input_50p").value == "") {
            input_50p = 0;
            document.getElementById("input_50p").value = 0;
        }
        else {
            input_50p = parseFloat(document.getElementById("input_50p").value);
            document.getElementById("input_50p").value = parseFloat(document.getElementById("input_50p").value);
        }
        //var in_50p = parseInt(document.getElementById("lbl_50p_in").innerHTML);
        //var out_50p = parseInt(document.getElementById("lbl_50p_out").innerHTML);
        //var DVal_50p = parseInt(document.getElementById("lbl_50p_DValue").innerHTML);
        //var AVal_50p = parseInt(document.getElementById("lbl_50p_AValue").innerHTML);
        //var input_50p = 0;
        //if (document.getElementById("input_50p").value == null || document.getElementById("input_50p").value == "") {
        //    input_50p = 0;
        //    document.getElementById("input_50p").value = 0;
        //}
        //else {
        //    input_50p = parseInt(document.getElementById("input_50p").value);
        //    document.getElementById("input_50p").value = parseInt(document.getElementById("input_50p").value);
        //}
        ...
        if (denom == "CheckBox") {
            if (PageType == "Deposit" || PageType == "SOD" || PageType == "CASHEX" || PageType == "CI01") {
                if (cashinout == "in" || cashinout == "v") {
                    ...
                    //debugger;
                    // 50 paise
                    var inAmt_50p = (0.5) * (in_50p + input_50p);
                    var outAmt_50p = (0.5) * (out_50p);
                    var sum_50p = inAmt_50p - outAmt_50p;
                    document.getElementById("lbl_50p_DValue").innerHTML = sum_50p;

                    if (PageType == "Deposit" || PageType == "SOD" || PageType == "CI01") {
                        document.getElementById("D_Amt").value = sum_2000 + sum_500 + sum_200 + sum_100 + sum_50 + sum_20 + sum_10 + sum_5 + sum_2 + sum_1 + sum_50p;
                    }
                    else if (PageType == "CASHEX") {
                        document.getElementById("in_cash").value = inAmt_2000 + inAmt_500 + inAmt_200 + inAmt_100 + inAmt_50 + inAmt_20 + inAmt_10 + inAmt_5 + inAmt_2 + inAmt_1 + inAmt_50p;
                    }
                    ...
                    //debugger;
                    // 50 Paise
                    var inAmt_50p = (0.5) * (in_50p);
                    var outAmt_50p = (0.5) * (out_50p + input_50p);
                    var sum_50p = inAmt_50p - outAmt_50p;
                    document.getElementById("lbl_50p_DValue").innerHTML = sum_50p;
                    ...
                    if (PageType == "Deposit" || PageType == "SOD" || PageType == "CI01") {
                        ...
                        document.getElementById("out_cash").value = outAmt_2000 + outAmt_500 + outAmt_200 + outAmt_100 + outAmt_50 + outAmt_20 + outAmt_10 + outAmt_5 + outAmt_2 + outAmt_1 + outAmt_50p;
                }
            }
        }
        else {
            if (PageType == "Deposit" || PageType == "SOD" || PageType == "CASHEX" || PageType == "CI01") {
                ...
                var sum_50p = (0.5) * (out_50p + input_50p);
                document.getElementById("lbl_50p_DValue").innerHTML = sum_50p;
    ...
    function resetCashToZero() {
        ...
        // 50 paise
        document.getElementById("lbl_50p_in").innerHTML = 0;
        document.getElementById("lbl_50p_out").innerHTML = 0;
        document.getElementById("lbl_50p_DValue").innerHTML = 0;
        document.getElementById("lbl_50p_AValue").innerHTML = 0;
        document.getElementById("input_50p").value = 0;
    ...
    function getSuccess_CashData_Sod(result) {
        ...
        //debugger;
        var DData = ["2000", "500", "200", "100", "50", "20", "10", "5", "2", "1", "0.5"];
        ...
        for (var i = 0; i < DData.length; i++) {
            for (var j = 0; j < result.length; j++) {
                if (result[j].Denoms == DData[i]) {
                    ...
                    else if (result[j].Denoms == "0.5") {
                        available_50p += dCount;
                    }
                }
            }
        }
        ...
        document.getElementById("lbl_50p_AValue").innerHTML = available_50p;
    ...
    function getSuccess_CashData(result) {
                ...
                if (result[j].currncy_denom == DData[i]) {
                    ...
                    if (PageType == "Deposit" || PageType == "SOD" || PageType == "CASHEX" || PageType == "CI01") {
                        if (result[j].cashinout == 'in' || result[j].cashinout == 'v') {
                            ...
                            else if (result[j].currncy_denom == "0.5") {
                                in_50p += 1;
                                dval_50p += parseFloat(paise_50);
                            }
                        }
        ...
        document.getElementById("lbl_50p_in").innerHTML = in_50p;
        document.getElementById("lbl_50p_out").innerHTML = out_50p;
        ...
        document.getElementById("lbl_50p_DValue").innerHTML = dval_50p;

        //debugger;

        if (PageType == "Deposit" || PageType == "WithDraw" || PageType == "CASHEX" || PageType == "DI01" || PageType == "CI01") {
            document.getElementById("lbl_total_in").innerHTML = in_2000 + in_500 + in_200 + in_100 + in_50 + in_20 + in_10 + in_5 + in_2 + in_1 + in_50p;
            document.getElementById("lbl_total_out").innerHTML = out_2000 + out_500 + out_200 + out_100 + out_50 + out_20 + out_10 + out_5 + out_2 + out_1 + out_50p;
            document.getElementById("D_Amt").value = dval_2000 + dval_500 + dval_200 + dval_100 + dval_50 + dval_20 + dval_10 + dval_5 + dval_2 + dval_1 + dval_50p;
            if (PageType == "CASHEX") {
                document.getElementById("in_cash").value = dval_2000 + dval_500 + dval_200 + dval_100 + dval_50 + dval_20 + dval_10 + dval_5 + dval_2 + dval_1 + dval_50p;
            }
        }
        else if (PageType == "SOD") {
            document.getElementById("D_Amt").value = dval_2000 + dval_500 + dval_200 + dval_100 + dval_50 + dval_20 + dval_10 + dval_5 + dval_2 + dval_1 + dval_50p;
            document.getElementById("denom_count").value = in_2000 + in_500 + in_200 + in_100 + in_50 + in_20 + in_10 + in_5 + in_2 + in_1 + in_50p;
        }
        else if (PageType == "EOD") {
            document.getElementById("D_Amt").value = dval_2000 + dval_500 + dval_200 + dval_100 + dval_50 + dval_20 + dval_10 + dval_5 + dval_2 + dval_1 + dval_50p;
            document.getElementById("denom_count").value = out_2000 + out_500 + out_200 + out_100 + out_50 + out_20 + out_10 + out_5 + out_2 + out_1 + out_50p;
        }
    ...
    function ManualDataEntry() {
        ...
        debugger;
        var d50p = document.getElementById("input_50p").value;
        if (d50p != null && d50p != "") {
            if (d50p > 0) {
                dArray_insert.push("0.5");
                dCount_insert.push(parseInt(d50p));
            }
        }
    ...
    function SubmitData() {
        ...
        if (PageType == "SOD" || PageType == "EOD" || PageType == "CASHEX") {
            ...
            dArray.push("0.5");
            dCount.push(document.getElementById("lbl_50p_in").innerHTML);
    ...
    function VerifyCashData() {
        ...
        var d1 = document.getElementById("input_50p").value;
        if (d1 != null && d1 != "") {
            if (d1 > 0) {
                document.getElementById("errorMsg").innerHTML = "Please Click on INSERT CASH button to Proceed";
                return false;
    ...
    function CheckDenomFlag_paise(denom) {
        debugger;
        var outCash = parseFloat(document.getElementById("lbl_" + denom + "_out").innerHTML);
        var input = parseFloat(document.getElementById("input_" + denom).value);
        var inCash = parseFloat(document.getElementById("lbl_" + denom + "_in").innerHTML);
        var AVal = parseFloat(document.getElementById("lbl_" + denom + "_AValue").innerHTML);
        // updated change
        debugger;
        if (PageType == "CASHEX") {
            if ((inCash + AVal) < (outCash + input)) {
