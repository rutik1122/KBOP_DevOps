try {
    ...
    function getCheckerData(result) {
        ...
        if (result.same_amt == false)
            $("#amt").css('backgroundColor', '#FDFA1A');
        ...
        if (transtype == 'CI01') {
            ...
            if (result.same_credit_acc_no == false)
                $("#AccountNo").css('backgroundColor', '#FDFA1A');
            ...
            //    $("#chqnoDataEntry").css('backgroundColor', '#FDFA1A');

            //document.getElementById("ChequeDateTxt").value = result.date;
            //if (result.same_cheque_date == false)
            //    $("#ChequeDateTxt").css('backgroundColor', '#FDFA1A');

            //if (result.same_uv_flag == false) {
            //    $("#uv_flag").css('backgroundColor', '#FDFA1A');
    ...
    function DataPush(descision) {
        ...
        if (descision == "B") {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    TransactionRefNo: RefNo, count_id: id, btnVal: 'BACK', Verf: verf, transactionType: transtype
                },
                success: CheckerList
                //success: window.open(rooturl + "Checker/Index", "_self")
            });
            ...
            $.ajax({
                ...
                data: {
                    ...
                    pancard_form_16: pan, BankCode: BankCode,
                    // Finacle posting
