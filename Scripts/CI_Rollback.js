try {
    ...
    function RecordTableRow(print) {
        ...
        if (Scanning_Type == "" || Scanning_Type == null) {
            debugger;
            if (print.transtype == "CI02") {
                Scanning_Type = "2";
                document.getElementById("spam_header").innerHTML = "Credit Intimation with cheque Rollback";
            }
            else if (print.transtype == "CI03") {
                Scanning_Type = "3";
                document.getElementById("spam_header").innerHTML = "Credit Intimation with Debit Intimation Rollback";
            }
            else if (print.transtype == "CI04") {
                Scanning_Type = "4";
                document.getElementById("spam_header").innerHTML = "Credit Intimation with Withdrawal Slip Rollback";
            }
        ...
        document.getElementById("id_branch_code").value = print.instrument_alpha;
