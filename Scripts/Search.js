try {
    ...
    function SubmitData() {
        ...
        if (val == "1") {
            ...
            var MachineNo = $("#MachineSerialNo_1").val();
            var TellerId = $("#TellerId_1").val();
            var TransRefNo = $("#TransRefNo_1").val();
            var SerialNo = $("#NoteSerialNo_1").val();
            //Branch = $("#Branch_1").val();

            var validate = false;

            if (MachineNo != "" || TellerId != "" || TransRefNo != "" || SerialNo != "")
                validate = true;
            ...
            $("#tbl_Cheque").find("tr:gt(0)").remove();

            document.getElementById("label_data_1").innerHTML = "Note Serial No.";
            ...
            $.ajax({
                ...
                data: {
                    'serialno': SerialNo, 'TellerID': TellerId, 'fromdate': FromDate, 'todate': ToDate, 'MachineSerialNo': MachineNo, 'TransRefNo': TransRefNo,
                    'SearchBy': 'CURRENCY'
                },
            ...
            var MachineNo = $("#MachineSerialNo_2").val();
            var TellerId = $("#TellerId_2").val();
            var TransRefNo = $("#TransRefNo_2").val();
            var ChequeNo = $("#ChequeNo_2").val();
            //Branch = $("#Branch_2").val();
            var Amount = $("#Amount_2").val();
            var DebitAccNo = $("#DebitAccNo_2").val();
            var CreditAccNo = $("#CreditAccNo_2").val();
            ...
            document.getElementById("label_data_1").innerHTML = "Cheque No.";
        ...
        if (RequestType == "1") {
            for (var i = 0; i < SerialData.length; i++) {
                ...
                if (val == "1")
                    ...
                    cell5.innerHTML = SerialData[i].chequeno;
            ...
            for (var i = 0; i < SerialData.length; i++) {
                ...
                var cell5 = row.insertCell(4);
                cell5.innerHTML = SerialData[i].DebitAccNo;
                row.appendChild(cell5);

                var cell6 = row.insertCell(5);
                cell6.innerHTML = SerialData[i].CreditAccNo;
                row.appendChild(cell6);

                var cell7 = row.insertCell(6);
                cell7.innerHTML = SerialData[i].payeeName;
                row.appendChild(cell7);

                var cell8 = row.insertCell(7);
                cell8.innerHTML = SerialData[i].sakAmount;
                row.appendChild(cell8);

                var cell9 = row.insertCell(8);
                var val = document.getElementById("SearchBy").value;
                if (val == "1")
                    cell9.innerHTML = SerialData[i].serialno;
                else if (val == "2")
                    cell9.innerHTML = SerialData[i].chequeno;
                row.appendChild(cell9);
                ...
                var cell11 = row.insertCell(10);
                cell11.innerHTML = SerialData[i].scanneddoctype;
                row.appendChild(cell11);

                var cell12 = row.insertCell(11);
                cell12.innerHTML = result[i].currncy_version;
                row.appendChild(cell12);

                var cell13 = row.insertCell(12);
                cell13.innerHTML = SerialData[i].currncy_denom;
                row.appendChild(cell13);

                var cell14 = row.insertCell(13);
                cell14.innerHTML = SerialData[i].output_pocket;
                row.appendChild(cell14);

                var cell15 = row.insertCell(14);
                cell15.innerHTML = SerialData[i].error_code;
                row.appendChild(cell15);

                var cell16 = row.insertCell(15);
                cell16.innerHTML = SerialData[i].TransRefNo;
                row.appendChild(cell16);

                document.getElementById("tbl_Cheque").appendChild(row);
